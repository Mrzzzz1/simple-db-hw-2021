...
public class BTreeFile implements DbFile {
    ...
    public BTreeLeafPage splitLeafPage(TransactionId tid, Map<PageId, Page> dirtypages, BTreeLeafPage page, Field field)
        ...
        if (rightSiblingId != null) {
            BTreeLeafPage oldRightPage = (BTreeLeafPage) getPage(tid, dirtypages, rightSiblingId, Permissions.READ_WRITE);
    ...
    public BTreeInternalPage splitInternalPage(TransactionId tid, Map<PageId, Page> dirtypages,
        ...
        BTreeEntry mid = reverseIterator.next();
    ...
    public void stealFromLeafPage(BTreeLeafPage page, BTreeLeafPage sibling,
        ...
        int curNum = page.getNumTuples();
        int targetNum = (curNum+sibling.getNumTuples())/2;
        ...
        entry.setKey(isRightSibling?sibling.iterator().next().getField(keyField):page.iterator().next().getField(keyField));
